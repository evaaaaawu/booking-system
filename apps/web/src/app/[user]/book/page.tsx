...
export default async function BookPage({ params }: PageProps) {
  ...
  return (
    <div>
      <Head>
        <title>
          Confirm your {eventType.title} with {userData.name} | Schedule System
        </title>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="sm:flex px-4 py-5 sm:p-6">
            <div className="sm:w-1/2 sm:border-r">
              ...
              />
              <h2 className="font-medium text-gray-500">{userData.name}</h2>
            ...
            <div className="sm:w-1/2 pl-8 pr-4">
              <BookingForm user={userData} eventType={eventType} />
            </div>
          </div>
        </div>
      </main>
